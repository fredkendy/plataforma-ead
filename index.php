<?php
    ...
    //Esta página será o "template" para todas as outras, como forma de evitar repetição de código
    //Esta receberá por GET o nome da página (p) que será incluída
    $pagina = "inicial.php";
    if (isset($_GET['p'])) {
        $pagina = $_GET['p'] . ".php";
    }

    // Pegando o id e dados do usuario
